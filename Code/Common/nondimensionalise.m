...
[N, q, Fph, kB, T, b, epsp, alpha, Ec, Ev, Dn, Dp, gc, gv, N0, DI, EcE, dE, ...
    ...
    betaE, betaH, vnE, vpE, vnH, vpH, Ect, Ean, Rs, Rp, Acell, jsc, j0, Rp2, ...
    stats, Plim, NonlinearFP, EfE, EfH, muE, muH, Verbose] ...
    = struct2array(params, ...
    ...
    'vnH','vpH','Ect','Ean','Rs','Rp','Acell','jsc','j0','Rp2','stats', ...
    'Plim','NonlinearFP','EfE','EfH','muE','muH','Verbose'});
